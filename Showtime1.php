...
$username = 'SMIT'; // Example: $username = 'ABCD';
$api_key = 'API Key';  //Example: $api_key = 'AbCdEFG7CuTTc6KX76mI5aAoGtqbrGW2ga6B4jRg';
$basic_authorization = 'Authorization Code '; // Example: $basic_authorization = 'Basic UHSYGF4xNTpNOHdJQllxckYyN3y=';
...
$geolocation = '39.702770;-75.111960'; // Device Geolocation. Note semicolon (;) used as separator. IMPORTANT: This MUST be a location in the territory you selected above. The sample location is set at: Leicester Square, London, UK
########
# cURL #
########
